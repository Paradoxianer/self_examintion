...
class AppLocalizationsDe extends AppLocalizations {
  ...
  List<String> get rating =>
      ["Sehr gut", "Guter Weg", "nicht so gut", "dringend dran arbeiten"];

  @override
  List<String> get answers =>
      ["Gar nicht", "Wenig", "Meistens", "Voll und ganz"];
  ...
  Map<String, SelfAssessmentQuestionSet> get questionMap {
    ...
    return {
      "Salvation Army Chemnitz": SelfAssessmentQuestionSet(
        ...
        description:
            "Selbstprüfungsfragen entwickelt von der Heilsarmee Chemnitz basierend auf den zehn Geboten.",
        questions: [
          Question(
              text:
                  "Inwieweit vermeide ich es, andere Dinge / Sachen neben dem einen wahren Gott zu setzen?",
              description:
                  "Du sollst keine anderen Götter haben neben mir!  (2. Mose 2, 1-6)",
              tips:
                  "Les mal die Bibel z.b. unter [www.bibelserver.com](https://bibelserver.com/)"),
          Question(
              text:
                  "Wie konsequent vermeide ich es, mir ein Bild von Gott zu machen oder anzufertigen?",
              description:
                  "Du sollst dir kein Gottesbild anfertigen! (2. Mose 2, 4)"),
          Question(
              text:
          ...
          Question(
              text:
                  "Nehme ich mir einmal aller sechs Tage einen Tag Auszeit, um Gott zu ehren?",
              description:
          ...
          Question(
              ...
              description:
                  "Ehre deinen Vater und deine Mutter! (2. Mose 2, 12)"),
          Question(
              text:
                  "Wie konsequent vermeide ich es andere Menschen in Gedanken mit Worten oder gar mit Taten Schaden zu zu fügen?",
              description: "Du sollst nicht töten! (2. Mose 2, 13)"),
          Question(
              text:
                  "Inwieweit halte ich mich von Ehebruch fern und bewahre die Ehe als heilige Institution?",
              description: "Du sollst nicht ehebrechen! (2. Mose 2, 14)"),
          Question(
              text:
          ...
          Question(
              text:
                  "In welchem Maße vermeide ich es, falsches Dinge über andere Menschen zu verbreiten oder zu lästern?",
              description:
                  "Du sollst kein falsches Zeugnis ablegen gegen deinen Nächsten! (2. Mose 2, 16)"),
          Question(
              text:
                  "Wie sehr vermeide ich es neidisch zu sein auf das was anderen Menschen gehört bzw. wie andere Menschen leben?",
              description:
                  "Du sollst nicht begehren deines Nächsten Haus! Du sollst nicht begehren deines Nächsten Weib, noch seinen Knecht, noch seine Magd, noch sein Rind, noch seinen Esel, noch irgend etwas, was deinem Nächsten gehört. (2. Mose 2, 16)")
        ],
      ),
      ...
      "John Wesley": SelfAssessmentQuestionSet(
        ...
        questions: [
          ...
          Question(
              text: "Widersetze ich mich Gott in irgendetwas?",
              isPositive: true),
          Question(
              text:
              ...
              isPositive: true),
          Question(
              text: "Bin ich in einem Teil meines Lebens unterlegen?",
              isPositive: true),
          Question(
              text:
          ...
          Question(
              ...
              isPositive: true),
          Question(
              text: "Murre oder beschwere ich mich ständig?", isPositive: true),
