...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get noHistory =>
      'No se encontraron datos. Elija un conjunto de preguntas diferente o responda las preguntas.';
  @override
  String get warningTitle => 'Advertencia';
  @override
  String warningDel(String autor, Object author) =>
      'Todo el progreso para $autor se eliminará. ¿Desea continuar?';
  @override
  ...
  @override
  String get dsgvo1 =>
      'Para realizar un seguimiento de su desarrollo espiritual personal, almacenamos sus respuestas localmente.';
  @override
  String get dsgvo2 =>
      'Tenga en cuenta que las personas que tienen acceso a su dispositivo pueden tener acceso a estos datos.';
  @override
  String get dsgvo3 =>
      'Al hacer clic en \'Aceptar\', acepta que se almacenen sus datos.';
  @override
  ...
  @override
  String get compareChart => 'Comparación';
  @override
  String get timeChart => 'Tiempo';
  @override
  ...
  List<String> get rating =>
      ["Excelente", "Buen camino", "No tan bueno", "Necesita trabajo"];
  @override
  List<String> get answers =>
      ["En absoluto", "Poco", "Mayormente", "Completamente"];
  @override
  List<String> get frequenze => ["diario", "semanal", "mensual", "anual"];

  @override
  String get filterQuestions => "Filtrar preguntas";
  @override
  ...
  String get radarError =>
      "El gráfico de radar requiere al menos 3 preguntas seleccionadas.";
  @override
  String get prevPeriod => "Período anterior";
  @override
  String get currPeriod => "Período actual";
  @override
  String get all => "Todo";
  @override
  List<String> get timeRangeShort => ["2D", "1S", "1M", "1A", "Todo"];
  ...
  Map<String, SelfAssessmentQuestionSet> get questionMap {
    return {
      "Salvation Army Chemnitz": SelfAssessmentQuestionSet(
        ...
        description:
            "Preguntas de autoevaluación basadas en los Diez Mandamientos.",
        questions: [
          Question(
              text: "¿Evito poner otras cosas junto al único Dios verdadero?"),
          Question(
              text: "¿Me abstengo de hacer o worshiping una imagen de Dios?"),
          Question(
              text: "¿Cuánto he evitado usar el nombre del Señor sin pensar?"),
          Question(
      ...
      "William Booth": SelfAssessmentQuestionSet(
        ...
        questions: [
          Question(
              text: "¿Soy habitualmente culpable de algún pecado?",
              isPositive: true),
          Question(text: "¿Soy el amo de mis apetitos corporales?"),
          Question(text: "¿Son mis pensamientos limpios ante Dios?"),
          Question(
              text: "¿Me hace el mundo hacer cosas diferentes a las de Cristo?",
              isPositive: true),
          Question(
              text: "¿Mis malhumores me hacen actuar contra el amor?",
              isPositive: true),
      ...
      "John Wesley": SelfAssessmentQuestionSet(
        ...
        questions: [
          ...
          Question(
              text: "¿Hago algo que molesta mi conciencia?", isPositive: true),
          ...
          Question(
              text: "¿Agradezco a Dios no ser como otros?", isPositive: true),
